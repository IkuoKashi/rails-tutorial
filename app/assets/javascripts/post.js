...
$(function() {
  $(document).on('click', '#comment_button', function() {
    ...
    var nico_comment = $('<div id="item" style="font-size: 36px; color: white; font-weight: bold; text-shadow: black 1px 1px 1px; width: 100px; white-space: nowrap; postion: absolute;">' +
    comment + '</li>').appendTo('#nicoscreen');
    
    
    
    // ↑で設定したコメントの座標をセットし、offsetに格納。高さはsetPositionで決定
    var offset = nico_comment.offset({ top: setPosition('#item'), 
    ...
    $('<li id="list_item" class="list-group-item list-group-item-light" color:black">' + comment + 
    '</li>').prependTo('#list');
